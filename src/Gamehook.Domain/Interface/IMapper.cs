...
public interface IMapper
{
    ...
    /// Reference tables declared by mapper. UI uses these to offer valid values for properties
    /// whose Reference points at one of them.
    IReadOnlyDictionary<string, ReferenceTable> References { get; }
